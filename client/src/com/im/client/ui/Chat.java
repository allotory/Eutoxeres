...
public class Chat extends JFrame{
	...
	//界面背景图片
	private ImageIcon main_bg_Icon = ImageManageUtils.getImageIcon("images/background/common/main_bg_common.jpg");
	//关闭按钮
	...
	//颜色
	private Color BLUE = new Color(52, 134, 218);
	...
	public void initUI(){
		...
		user_img_normal_border.setVisible(false);
